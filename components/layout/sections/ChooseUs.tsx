          ...
          <div className="relative bg-[#0F0F0F] rounded-[2.5rem] p-8 md:p-12 border border-white/5 shadow-2xl">
            ...
            <div className="space-y-4">
              ...
              <div className="pt-6 space-y-5">
                <a
                  href="tel:9876543210"
                  className="w-full flex items-center justify-center gap-3 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold text-[10px] uppercase tracking-[0.2em] transition-all active:scale-95 shadow-lg shadow-blue-600/40"
                >
